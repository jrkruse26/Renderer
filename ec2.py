...
def stop_instance():
    inst_id = get_instances('Renderer')
    ec2_client = boto3.client('ec2', region_name='us-east-2')
...
if instance_id is None:
    ...
    while instance_id is None:
        instance_id = get_instances('Renderer')
        time.sleep(1)
...
time.sleep(20)
subprocess.Popen(['C:\\Program Files (x86)\\WinSCP\\WinSCP.exe','sftp://ubuntu@{}'.format(ip), '/privatekey=C:\\Users\\Jordan\\Documents\\Renderer\\Renderer.ppk','/hostkey=*'])
